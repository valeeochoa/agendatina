...
try {
    // Limpiar valores de prueba antiguos (ej. 13333 que producía $12.000)
    $pdo->exec("UPDATE configuracion_global SET precio_basico = 8889, precio_intermedio = 11111, precio_premium = 16667, descuento_porcentaje = 10 WHERE id = 1 AND precio_basico > 12000");
