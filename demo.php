...
if ($shouldReset && $negocioId) {
    ...
    $pdo->prepare("INSERT INTO turnos (id_negocio, cliente_nombre, cliente_celular, fecha, hora, servicio, profesional, id_servicio, estado, asistio, precio) VALUES 
        ...
        (?, 'Sofía Pérez', '1144556677', ?, '11:00', 'Masaje Relajante', 'Valentina', ?, 'confirmado', 0, 15000),
        (?, 'Mateo Gómez', '1177889900', ?, '17:30', 'Corte de Demostración', 'Valentina', ?, 'pendiente', 0, 8000),
        (?, 'Valentina Silva', '1188990011', ?, '10:30', 'Manicura Semipermanente', 'Sofía', ?, 'confirmado', 0, 9000),
        (?, 'Joaquín Navarro', '1122334455', ?, '14:00', 'Limpieza Facial Profunda', 'Camila', ?, 'confirmado', 0, 12000),
        (?, 'Camila Torres', '1199001122', ?, '16:00', 'Perfilado de Cejas', 'Marcos', ?, 'confirmado', 0, 5000),
        ...
        (?, 'Martina López', '1177665544', ?, '16:00', 'Limpieza Facial Profunda', 'Camila', ?, 'confirmado', 1, 12000),
        (?, 'Agustín Vega', '1188776655', ?, '11:00', 'Perfilado de Cejas', 'Marcos', ?, 'confirmado', 1, 5000),
        (?, 'Belén Castro', '1199887766', ?, '15:30', 'Manicura Semipermanente', 'Sofía', ?, 'confirmado', 1, 9000),
        (?, 'Nicolas Benítez', '1122446688', ?, '10:30', 'Corte de Demostración', 'Valentina', ?, 'confirmado', 1, 8000),
        (?, 'Paula Acosta', '1133557799', ?, '12:00', 'Masaje Relajante', 'Valentina', ?, 'confirmado', 1, 15000),
        (?, 'Esteban Morales', '1144668800', ?, '17:00', 'Limpieza Facial Profunda', 'Camila', ?, 'confirmado', 1, 12000),
        (?, 'Florencia Herrera', '1155779911', ?, '11:30', 'Manicura Semipermanente', 'Sofía', ?, 'confirmado', 1, 9000),
        (?, 'Gonzalo Peralta', '1166880022', ?, '15:00', 'Corte de Demostración', 'Valentina', ?, 'confirmado', 1, 8000)
    ")->execute([
